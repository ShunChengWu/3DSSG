...
def Parse():
    ...
    parser.add_argument('--target_name','-n', default='2dssg_seq.json', help='target graph json file name')
...
def save_one_scene(data:dict, h5data):
    ...
    if 'kfs' in h5data: del h5data['kfs']
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=os.path.join(outdir,filename+'.log'), level=logging.DEBUG)
