    ...
    def __init__(self,cfg,backbone:str,device):
        ...
        if self.backbone == 'vgg16':
            if self.node_feature_dim != 25088:
                logger_py.warning('overwrite node_feature_dim from {} to {}'.format(self.node_feature_dim,25088))
            ...
            if self.node_feature_dim != 512:
                logger_py.warning('overwrite node_feature_dim from {} to {}'.format(self.node_feature_dim,512))
            ...
            logger_py.info('use self defined backbone. please define self.nn_enc and self.nn_post in your init.')
        else:
    ...
    def postprocess(self, images, kf2box):
        ...
        if not self.input_is_roi:
            ...
            if self.use_global:
                ...
                img_features = torch.zeros([len(boxes), self.node_feature_dim],device=self._device)
